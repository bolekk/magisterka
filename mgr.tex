...
Results for the {\bf uniform} setting are shown on figures \ref{uniform_1}, \ref{uniform_3} and \ref{uniform_5}.\\
...
Results for the {\bf uniform continuous} setting are depicted in figures \ref{uni_cont_1}, \ref{uni_cont_3} and \ref{uni_cont_5}. In the \\
