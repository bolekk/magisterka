...
\textcolor{red}{TODO: dwa inne problemy NP?}\\

% INNY LEPSZY PROBLEM (wciaz kliki): ustalony staly max rozmiar kliki i max jakiejs miary pokrycia (sume? sume kwadratow?)
% Jeszcze inny DLA TIME-SLOT: Nie ma klik, dobieramy kazdemu gosciowi K innych i max miary.
...
We claim that as the system evolves, private measures lose their significance.
