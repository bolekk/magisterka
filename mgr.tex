...
In this chapter we analyze various approaches to data replication in peer-to-peer systems, categorized with respect to the degree of centralization. We begin with a discussion regarding the model of peers' availability. Afterwards, we present some of the existing results and also propose a new approach.\\

\section{General assumptions}

1. Kazdy replikuje wielokrotnosc jakiejs jednostki ilosci danych (w wiekszosci przypadkow wszyscy po tyle samo ale nie koniecznie)
...
*** gdzie napisac o klikach?

\section{Availability models}
